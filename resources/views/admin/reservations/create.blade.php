        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
           ...
           <form action="{{ route('admin.reservations.store') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="email"  value="{{ old('email') }}" name="email" id="email" class="@error('email') border-red-400 @enderror bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"  required>
                @error('email')
                    <div class="text-sm text-red-400">{{ $message }}</div>
                @enderror
            </div>
