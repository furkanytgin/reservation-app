        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
           ...
           <form action="{{ route('admin.menus.store') }}" enctype="multipart/form-data" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="text"  value="{{ old('name') }}" name="name" id="name" class="@error('name') border-red-400 @enderror bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"  required>
                @error('name')
            ...
            <div class="mb-6">
                ...
                <div class="flex flex-row">
                    ...
                    <input type="number"  value="{{ old('price') }}" name="price" class="@error('price') border-red-400 @enderror bg-grey-lighter text-grey-darker py-2 rounded text-grey-darkest border border-grey-lighter rounded-l-none font-bold">
                </div>
                @error('price')
                    <div class="text-sm text-red-400">{{ $message }}</div>
                @enderror
